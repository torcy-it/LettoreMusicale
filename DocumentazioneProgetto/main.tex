...
\begin{document}
	...
	\\
	\\
	\includegraphics[width=0.8\linewidth]{Dominio del Problema.png} \footnote{link : \href{https://github.com/torcy-it/LettoreMusicale/tree/main/DocumentazioneProgetto/ClassDiagrams}{Class diagram nel dominio del Problema}}
	...
	\\
	\\
	\includegraphics[width=1\linewidth]{dominio Della soluzione.png} \footnote{link : \href{https://github.com/torcy-it/LettoreMusicale/tree/main/DocumentazioneProgetto/ClassDiagrams}{Class diagram nel dominio della Soluzione}}
	...
	\begin{figure}[h]
		\centering
		\subfigure[ProfiloPersonale]{\label{fig:a}\includegraphics[width=60mm,height=60mm]{ProfiloPersonale1.png}} 
		\subfigure[ProfiloPersonale2]{\label{fig:b}\includegraphics[width=60mm,height=60mm]{ProfiloPersonale2.png}}
	\end{figure}
	...
	\begin{figure}[h]
		\centering
		\subfigure[ProfiloAscoltatore2]{\label{fig:a}\includegraphics[width=60mm,height=60mm]{ProfiloArtista.png}} 
		\subfigure[ProfiloAscoltatore2]{\label{fig:b}\includegraphics[width=60mm,height=60mm]{ProfiloArtista1.png}}
	\end{figure}
